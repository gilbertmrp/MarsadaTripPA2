...
<div class="card">
    <div class="card-body">
      ...
      <form action="{{ url('/mobil/edit-process/'.$updateCar->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
          <label for="inputText" class="col-sm-2 col-form-label">Nama : </label>
          <div class="col-sm-10">
            <input type="text" name="nama_mobil" class="form-control" value="{{ $updateCar->nama_mobil }}">
          </div>
          @error('nama_mobil')
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="file" name="gambar" class="form-control" value="{{ $updateCar->gambar }}">
          </div>
          @error('gambar')
              <div class="text-danger">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea name="lokasi" id="lokasi" class="form-control" rows="10" style="resize:none;">{{ $updateCar->lokasi }}</textarea>
          </div>
          @error('lokasi')
              <div class="text-danger">
