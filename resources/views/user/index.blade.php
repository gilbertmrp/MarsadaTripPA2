                ...
                <div class="main-menu-wrapper clearfix">
                            ...
                            <ul class="main-menu__list">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="listings-details.html">Listings Details</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#">Pages</a>
                    ...
                    <div class="main-menu-wrapper__right">
                        <div class="main-menu-wrapper__search-box-cart-box">
                            ...
                            <a href="#" class="main-menu-wrapper__cart icon-shopping-cart mini-cart__toggler"></a>
                        </div>
                        <div class="main-menu-wrapper__btn-box">
                            <a href="#" class="thm-btn main-menu-wrapper__btn">Submit Ad</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <section class="premium-ride">
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">Meet the Right Services</span>
                    <h2 class="section-title__title">Ride Premium Cars</h2>
                </div>
                <div class="row">
                    <div class="col-xl-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-left">
                            ...
                            <h2 class="section-title__title">Featured Rent Cars</h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-4">
                        <div class="featured-one__btn-box">
                            <a href="#" class="thm-btn featured-one__btn">View All Cars</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="explore-car__single">
                            <div class="explore-car__img">
                                <img src="assets/images/resources/explore-car-img-2.jpg" alt="">
                                <div class="explore-car__icon">
                                    <i class="far fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="explore-car__single">
                            <div class="explore-car__img">
                                <img src="assets/images/resources/explore-car-img-3.jpg" alt="">
                                <div class="explore-car__icon">
                                    <i class="far fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="explore-car__single">
                            <div class="explore-car__img">
                                <img src="assets/images/resources/explore-car-img-4.jpg" alt="">
                                <div class="explore-car__icon">
                                    <i class="far fa-heart"></i>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="assets/images/blog/news-one-1.jpg" alt="">
                            ...
                            <div class="news-one__content">
                                <ul class="list-unstyled news-one__meta">
                                    <li><a href="news-details.html"><i class="fas fa-tags"></i> Rental</a></li>
                                    <li><a href="news-details.html"><i class="fas fa-comments"></i> 2 Comments</a>
                                    </li>
                                </ul>
                                <h3 class="news-one__title">
                                    <a href="news-details.html">Guide to Create a Listing Based Business</a>
                                </h3>
                                <div class="news-one__person">
                                    <div class="news-one__person-img">
                                        <img src="assets/images/blog/news-one-person-1.png" alt="">
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="assets/images/blog/news-one-2.jpg" alt="">
                                <div class="news-one__date-box">
                                    <p>20 <br> Apr</p>
                                </div>
                                <a href="news-details.html">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__person">
                                    <div class="news-one__person-img">
                                        <img src="assets/images/blog/news-one-person-2.png" alt="">
                                    </div>
                                    <div class="news-one__person-text">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="assets/images/blog/news-one-3.jpg" alt="">
                                <div class="news-one__date-box">
                                    <p>20 <br> Apr</p>
                                </div>
                                <a href="news-details.html">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__person">
                                    <div class="news-one__person-img">
                                        <img src="assets/images/blog/news-one-person-3.png" alt="">
                                    </div>
                                    <div class="news-one__person-text">
