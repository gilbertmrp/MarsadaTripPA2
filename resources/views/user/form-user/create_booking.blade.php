				...
				<div class="row">
					...
					<div class="col-md-7 col-md-offset-1">
						<div class="booking-form">
							<form action="{{ url('/booking/add-process')}}" method="POST">
                                @csrf
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Nama</span>
											<input class="form-control" type="text" placeholder="name" name="nama_pemesan">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Nama Mobil</span>
											<input class="form-control" type="text" placeholder="Avanza,Fortuner" name="nama_mobil" >
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input class="form-control" type="date" required name="date_booking">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Tanggal Kembali</span>
											<input class="form-control" type="date" required name="date_checkout">
										</div>
									</div>
								</div>
                                <div class="form-group">
